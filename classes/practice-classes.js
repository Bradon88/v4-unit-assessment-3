...
const ralphsLocation = this.location
...
//   constructor(name, type){
//     super(name, type)
//     this.healthLevel = this.healthLevel
//     this.attackLevel = this.attackLevel
//   }
//   defend = (amount) => {
...
// battle = (aang.attackLevel) => {ozai.defend}
...
class Hero extends Player{
  ...
  addSuperPower = (power) => {this.superPowers.push(power)}
  useSuperPower = (index) => {`${this.name} used ${index}!`}
}
...
addSuperPower('spitting fire', 'roar', 'stomp')
useSuperPower(0) = fireSpitterAttack
